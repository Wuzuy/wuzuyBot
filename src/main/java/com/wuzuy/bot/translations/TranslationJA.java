...
public class TranslationJA extends ListenerAdapter {
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        TextChannel chat = event.getGuild().getTextChannelById("1285404836963291279");
        ...
        if (event.getChannel().getId().equalsIgnoreCase(chat.getId())) {
            ...
            try {
                ...
                String mensagemTraducao = GoogleTranslate.translate("ja", mensagemEnviada);
                ...
                if (!linguagem.equalsIgnoreCase("ja")) {
