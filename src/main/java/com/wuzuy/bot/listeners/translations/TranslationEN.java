...
public class TranslationEN extends ListenerAdapter {
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        TextChannel chat = event.getGuild().getTextChannelById("1285404787977879582");
        ...
        if (event.getChannel().getId().equalsIgnoreCase(chat.getId())) {
            ...
            try {
                ...
                String mensagemTraducao = GoogleTranslate.translate("en", mensagemEnviada);
